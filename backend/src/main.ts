...
import { ppeRouter } from "./routes/ppe.routes.js";
import { documentsRouter } from "./routes/documents.routes.js";
import { solutionsRouter } from "./routes/solutions.routes.js";
import { safetyBriefingsRouter } from "./routes/safetyBriefings.routes.js";
...
app.use("/api/trainings", authenticate, trainingsRouter);
app.use("/api/ppe", authenticate, ppeRouter);
app.use("/api/documents", authenticate, documentsRouter);
app.use("/api/solutions", authenticate, solutionsRouter);
app.use("/api/safety-briefings", authenticate, safetyBriefingsRouter);
