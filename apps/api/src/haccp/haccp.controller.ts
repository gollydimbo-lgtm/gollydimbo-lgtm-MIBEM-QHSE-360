...
import { CreateHaccpStudyDto, UpdateHaccpStudyDto, AddHaccpTeamMemberDto, CreateHaccpProcessStepDto, UpdateHaccpProcessStepDto, CreateHaccpHazardDto, UpdateHaccpHazardDto, CreateHaccpCcpDto, UpdateHaccpCcpDto, CreateHaccpMonitoringRecordDto, UpdateHaccpMonitoringRecordDto, CreateHaccpPrpDto, UpdateHaccpPrpDto } from './haccp.dto';
...
export class HaccpController {
  ...
  @Post('studies') studyCreate(@Body() b: CreateHaccpStudyDto) { return this.s.studyCreate(b); }
  @Get('studies/:id') studyGet(@Param('id') id: string) { return this.s.studyGet(id); }
  @Patch('studies/:id') studyUpdate(@Param('id') id: string, @Body() b: UpdateHaccpStudyDto) { return this.s.studyUpdate(id, b); }
  ...
  @Post('studies/:id/team') teamAdd(@Param('id') id: string, @Body() b: AddHaccpTeamMemberDto) { return this.s.teamAdd(id, b); }
  ...
  @Post('studies/:id/steps') stepCreate(@Param('id') id: string, @Body() b: CreateHaccpProcessStepDto) { return this.s.stepCreate(id, b); }
  @Post('studies/:id/steps/reorder') stepsReorder(@Param('id') id: string, @Body() b: any) { return this.s.stepsReorder(id, b); }
  @Patch('steps/:id') stepUpdate(@Param('id') id: string, @Body() b: UpdateHaccpProcessStepDto) { return this.s.stepUpdate(id, b); }
  ...
  @Post('steps/:stepId/hazards') hazardCreate(@Param('stepId') stepId: string, @Body() b: CreateHaccpHazardDto) { return this.s.hazardCreate(stepId, b); }
  @Patch('hazards/:id') hazardUpdate(@Param('id') id: string, @Body() b: UpdateHaccpHazardDto) { return this.s.hazardUpdate(id, b); }
  ...
  @Post('hazards/:hazardId/ccps') ccpCreate(@Param('hazardId') hazardId: string, @Body() b: CreateHaccpCcpDto) { return this.s.ccpCreate(hazardId, b); }
  @Patch('ccps/:id') ccpUpdate(@Param('id') id: string, @Body() b: UpdateHaccpCcpDto) { return this.s.ccpUpdate(id, b); }
  ...
  @Post('ccps/:ccpId/monitoring') monitoringCreate(@Param('ccpId') ccpId: string, @Body() b: CreateHaccpMonitoringRecordDto) { return this.s.monitoringCreate(ccpId, b); }
  @Patch('monitoring/:id') monitoringUpdate(@Param('id') id: string, @Body() b: UpdateHaccpMonitoringRecordDto) { return this.s.monitoringUpdate(id, b); }
  ...
  @Post('prps') prpCreate(@Body() b: CreateHaccpPrpDto) { return this.s.prpCreate(b); }
  @Patch('prps/:id') prpUpdate(@Param('id') id: string, @Body() b: UpdateHaccpPrpDto) { return this.s.prpUpdate(id, b); }
