...
export class HaccpController {
  ...
  @Delete('studies/:id') studyDelete(@Param('id') id: string) { return this.s.studyDelete(id); }
  ...
  @Delete('team/:memberId') teamRemove(@Param('memberId') memberId: string) { return this.s.teamRemove(memberId); }
  ...
  @Delete('steps/:id') stepDelete(@Param('id') id: string) { return this.s.stepDelete(id); }
  ...
  @Delete('hazards/:id') hazardDelete(@Param('id') id: string) { return this.s.hazardDelete(id); }
  ...
  @Delete('ccps/:id') ccpDelete(@Param('id') id: string) { return this.s.ccpDelete(id); }
  ...
  @Delete('prps/:id') prpDelete(@Param('id') id: string) { return this.s.prpDelete(id); }
}
