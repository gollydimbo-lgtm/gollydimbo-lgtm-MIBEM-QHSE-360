...
@Get('types') typeList(){return this.s.typeList()} @Post('types') typeCreate(@Body()b:any){return this.s.typeCreate(b)} @Patch('types/:id') typeUpdate(@Param('id')id:string,@Body()b:any){return this.s.typeUpdate(id,b)} @Delete('types/:id') @Roles(RoleName.ADMINISTRATEUR,RoleName.RESPONSABLE_QHSE) typeDelete(@Param('id')id:string){return this.s.typeDelete(id)}
@Get('categories') categoryList(){return this.s.categoryList()} @Post('categories') categoryCreate(@Body()b:any){return this.s.categoryCreate(b)} @Patch('categories/:id') categoryUpdate(@Param('id')id:string,@Body()b:any){return this.s.categoryUpdate(id,b)} @Delete('categories/:id') @Roles(RoleName.ADMINISTRATEUR,RoleName.RESPONSABLE_QHSE) categoryDelete(@Param('id')id:string){return this.s.categoryDelete(id)}
...
@Post(':id/approve') @Roles(RoleName.ADMINISTRATEUR,RoleName.RESPONSABLE_QHSE) approve(@Param('id')id:string,@Body()b:any){return this.s.approve(id,b)}
